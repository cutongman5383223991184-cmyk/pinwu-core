package com.pinwu.common.utils.file;
...
import com.pinwu.common.exception.file.FileNameLengthLimitExceededException;
import com.pinwu.common.exception.file.FileSizeLimitExceededException;
import com.pinwu.common.exception.file.InvalidExtensionException;
import com.pinwu.common.utils.uuid.IdUtils;
import com.pinwu.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = PinwuConfig.getProfile();
    ...
    {
        int dirLastIndex = PinwuConfig.getProfile().length() + 1;
